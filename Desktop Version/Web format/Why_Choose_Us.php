          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <article class="post media-post clearfix pb-0 mb-10">
                <a href="#" class="post-thumb mr-20"><img alt="" style="height: 120px; width: 120px;" src="https://media1.s-nbcnews.com/i/newscms/2016_36/1156042/home-carbon-monxide-today-160906-tease_c5eeae8c7b5c1262b693a175f769fbbf.jpg"></a>
                <div class="post-right">
                  <h4 class="mt-0 mb-5"><a href="#">Upcoming Event Title</a></h4>
                  <ul class="list-inline font-12 mb-5">
                    <li class="pr-0"><i class="fa fa-calendar mr-5"></i> June 26, 2017 |</li>
                    <li class="pl-5"><i class="fa fa-map-marker mr-5"></i>Dhaka</li>
                  </ul>
                  <p class="mb-0 font-13">EvAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA</p>
              ...
              <article class="post media-post clearfix pb-0 mb-10">
                ...
                <div class="post-right">
                  ...
                  <p class="mb-0 font-13">EAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA,</p>
                  <a class="text-theme-colored font-13" href="#">Read More →</a>
                </div>
              </article>
              <article class="post media-post clearfix pb-0 mb-10">
                ...
                <div class="post-right">
                  ...
                  <p class="mb-0 font-13">AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA,</p>
                  <a class="text-theme-colored font-13" href="#">Read More →</a>
                </div>
              </article>
            </div>
            <div class="col-md-6">
              ...
              <p class="mb-10">AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA</p>
              <div id="accordion1" class="panel-group accordion">
                <div class="panel">
                  ...
                  <div id="accordion11" class="panel-collapse collapse in" role="tablist" aria-expanded="true">
                    <div class="panel-content">
                      <p>EAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAs,</p>
                    </div>
                  </div>
                </div>
                <div class="panel">
                  ...
                  <div id="accordion12" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                    <div class="panel-content">
                      <p>EAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA,</p>
                    </div>
                  </div>
                </div>
                <div class="panel">
                ...
                <div class="panel">
                  ...
                  <div id="accordion14" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                    <div class="panel-content">
                      <p>EvAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAs,</p>
                    </div>
                  </div>
                </div>
                <div class="panel">
                  ...
                  <div id="accordion15" class="panel-collapse collapse" role="tablist" aria-expanded="true">
                    <div class="panel-content">
                      <p>EveAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA,</p>
                    </div>
                  </div>
                </div>
              </div>
